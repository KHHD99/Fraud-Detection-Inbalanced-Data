...
def Test():
    ...
    def apply_model_and_display(df, load_clf, method_name):
        if df is not None:
            if load_clf.endswith('.pkl'):
                    print('pkl')
                    load_clf = pickle.load(open(f'Models/{load_clf}', 'rb'))
            elif load_clf.endswith('.pbz2'):
                    print('pbz2')
                    load_clf = bz2.BZ2File(open(f'Models/{load_clf}', 'rb'))
                    load_clf = pickle.load(load_clf)
    ...
    def RF():
        ...
        if   dataset_choice == 'Credit-Card Dataset':
            ...
            methods_RF = [
                ('CMIYC/CMIYC_RandomForestClassifier_RUS.pbz2', 'RUS'), ('CMIYC/CMIYC_RandomForestClassifier_ROS.pbz2', 'ROS'),
                ('CMIYC/CMIYC_RandomForestClassifier_SMOTE.pbz2', 'SMOTE'), ('CMIYC/CMIYC_RandomForestClassifier_SMOTEENN.pbz2', 'SMOTEENN'),
                ('CMIYC/CMIYC_RandomForestClassifier_BSMOTE.pbz2', 'BSMOTE'), ('CMIYC/CMIYC_RandomForestClassifier_ADASYN.pbz2', 'ADASYN')
            ]
        elif dataset_choice == 'IEEE dataset':
             methods_RF = [
             ...
             methods_RF = [
                ('LOAN/LOAN_RandomForestClassifier_RUS.pbz2', 'RUS'), ('LOAN/LOAN_RandomForestClassifier_ROS.pbz2', 'ROS'),
                ('LOAN/LOAN_RandomForestClassifier_SMOTE.pbz2', 'SMOTE'), ('LOAN/LOAN_RandomForestClassifier_SMOTEENN.pbz2', 'SMOTEENN'),
                ('LOAN/LOAN_RandomForestClassifier_BSMOTE.pbz2', 'BSMOTE'), ('LOAN/LOAN_RandomForestClassifier_ADASYN.pbz2', 'ADASYN')
             ]
        elif dataset_choice == 'NSD dataset':
             methods_RF = [
                ('NSD/NSD_RandomForestClassifier_RUS.pbz2', 'RUS'), ('NSD/NSD_RandomForestClassifier_ROS.pbz2', 'ROS'),
                ('NSD/NSD_RandomForestClassifier_SMOTE.pbz2', 'SMOTE'), ('NSD/NSD_RandomForestClassifier_SMOTEENN.pbz2', 'SMOTEENN'),
                ('NSD/NSD_RandomForestClassifier_BSMOTE.pbz2', 'BSMOTE'), ('NSD/NSD_RandomForestClassifier_ADASYN.pbz2', 'ADASYN')
             ]
        else:
             methods_RF = [
                ('PS17/PS17_RandomForestClassifier_RUS.pbz2', 'RUS'), ('PS17/PS17_RandomForestClassifier_ROS.pbz2', 'ROS'),
                ('PS17/PS17_RandomForestClassifier_SMOTE.pbz2', 'SMOTE'), ('PS17/PS17_RandomForestClassifier_SMOTEENN.pbz2', 'SMOTEENN'),
                ('PS17/PS17_RandomForestClassifier_BSMOTE.pbz2', 'BSMOTE'), ('PS17/PS17_RandomForestClassifier_ADASYN.pbz2', 'ADASYN')
             ]
